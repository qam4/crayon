...
inline bool char_to_mo5(char c, CharMapping& out) {
    switch (c) {
        case 'A': case 'a': out = {MO5Key::A, false}; return true;
        ...
        case 'M': case 'm': out = {MO5Key::M, false}; return true;
        ...
        case 'Q': case 'q': out = {MO5Key::Q, false}; return true;
        ...
        case 'W': case 'w': out = {MO5Key::W, false}; return true;
        case 'X': case 'x': out = {MO5Key::X, false}; return true;
        case 'Y': case 'y': out = {MO5Key::Y, false}; return true;
        case 'Z': case 'z': out = {MO5Key::Z, false}; return true;
        ...
        case '.':  out = {MO5Key::PERIOD, false}; return true;
        ...
        case '/':  out = {MO5Key::DIV, false}; return true;
